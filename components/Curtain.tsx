 ...
 * ShowtimeCountdown
 * -------------------------------------------------------------------------
 * Cinema-marquee birthday countdown.
 *
 * At zero:
...
export interface ShowtimeCountdownProps {
  ...
  /** Subtitle under marquee title. */
  marqueeSub?: string;

  /** Caption under countdown. */
  doorsText?: string;

  /** Optional audio file for the lock screen. */
  songSrc?: string;

  /** Audio volume, 0–1. */
  songVolume?: number;

  /** Optional route to navigate to when countdown completes. */
  redirectTo?: string;

  /** Real page content shown after countdown. */
  children?: ReactNode;
  ...
  const overlay = (
    ...
    >
      ...
      <div className="lock">
        ...
        <div className="screen">
          ...
          >
            ...
            <div
              className="bulb-rail bottom"
              ref={bulbBottomRef}
            />

            <h1 className="marquee-title">
              <span
                className="marquee-title-star"
                aria-hidden="true"
              >
                ✦
              </span>
      ...
      <style>{`
        ...
        .showtime-root .corner-tl {
          top: 10px;
          left: 12px;
        }

        .showtime-root .corner-tr {
          top: 10px;
          right: 12px;
        }

        .showtime-root .corner-bl {
          bottom: 10px;
          left: 12px;
        }

        .showtime-root .corner-br {
          bottom: 10px;
          right: 12px;
        }
